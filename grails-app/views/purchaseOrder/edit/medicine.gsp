...
<head>
	...
	<r:require modules="bootstrap-css, bootstrap-collapse, bootstrap-tooltip, adminMedicine, jquery-ui"/>
</head>
<body>
		...
		<div class="col-md-4">
			...
			<g:form autocomplete="off">
				<div class="form-group">
					...
					<g:select name="product" from="${ni.sb.Medicine.findAllByProviderInListAndStatus(purchaseOrder.providers, true)}" optionKey="id" optionValue="name" class="form-control"data-toggle="tooltip" data-placement="left" title="Producto"/>
				</div>
