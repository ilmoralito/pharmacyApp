...
grails.plugin.springsecurity.ui.forgotPassword.emailBody = """
  ...
  <p>
    Usted ha realizado una solicitud para restaurar su contaseña.
    Para confirmar la accion has clic en el siguiente enlace:
    <br>
    <a href='$url'>Restaurar Contraseña</a>
  </p>
"""
...
ni {
  sb {
    companyName = "FARMACIA DORITA"
    companyRUC = ""
    companyAddress = "Basilica catedral de Leon 2C al norte"
