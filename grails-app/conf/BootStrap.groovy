  ...
  def init = { servletContext ->
    ...
    switch(Environment.current) {
      case Environment.DEVELOPMENT:
        ...
        //+++++++++++++++++++++++++++++++++++++++++++++++++++
        def today = new Date()
        def purchaseOrder1 = new PurchaseOrder(provider:provider1, dutyDate:today + 31, invoiceNumber:"001", typeOfPurchase:"Credito", balance:0)
        ...
        def purchaseOrder2 = new PurchaseOrder(provider:provider2 ,dutyDate:today + 60, invoiceNumber:"002", typeOfPurchase:"Contado", balance:0)
